<template>
  <el-dialog title="新增" :visible.sync="data.dialogTableVisible" @close="close" width="700px" @open="openDialog">
    <el-form :model="form" >
...
<script>
  ...
  import { role, userAdd , getSystem , permButton } from "@/api/user";
    ...
    setup(props, { root, emit, refs }) {
      ...
      const submitForm = (() => {
            ...
            if (form.pass === "") {
              ...
              return;
            } else if (validateP(form.pass))  {
              root.$message({
                message: "密码格式为6到20位数字字母组合",
                type: "error"
              });
              return
            };
